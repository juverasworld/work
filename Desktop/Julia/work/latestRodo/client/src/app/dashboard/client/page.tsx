...
export default function ProfessionalProfilePage() {
  ...
  // Toggle dropdown menu (nav links, filters, notifications)
  const toggleMenu = () => {
  ...
  return (
    <>
        ...
        <div className="max-w-[1500px] mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="bg-white p-2 rounded-full shadow-sm relative"
            >
      ...
      <div className="flex flex-col md:flex-row min-h-screen bg-gray-50 text-[#6D758F]">
        {/* Filter Sidebar - Hidden on small screens unless toggled */}
        <aside
          className={`${
            filterOpen ? "block" : "hidden"
          } md:block w-full md:w-72 border-r p-6 bg-white fixed md:static top-0 left-0 h-full z-50 md:z-auto transition-transform duration-300`}
        >
        ...
        {/* Notification Panel - Toggles on all screens */}
        {notificationsOpen && (
          <div className="fixed top-0 right-0 w-full max-w-sm h-full md:h-auto md:max-h-[80vh] bg-white shadow-lg p-6 z-50 transition-transform duration-300 md:rounded-lg md:mt-16 md:mr-4">
            ...
            <div className="space-y-4 overflow-y-auto">
              <div className="p-3 border rounded-lg">
                <p className="text-sm">New booking request received.</p>
                <span className="text-xs text-gray-500">2 hours ago</span>
              </div>
              <div className="p-3 border rounded-lg">
                <p className="text-sm">Profile review submitted.</p>
